...
import com.lueinfo.tractorapp.Fragment.EpicFrag;

public class Epicssoul extends AppCompatActivity {
    ImageView logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_epicssoul);
    ...
    {
        Fragment fragment=new EpicFrag();
