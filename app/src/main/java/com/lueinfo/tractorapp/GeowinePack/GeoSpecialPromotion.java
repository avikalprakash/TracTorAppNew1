...
public class GeoSpecialPromotion extends AppCompatActivity {
    GridView grid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_special_promotion);
    ...
    public void populatedata(){
        ...
        pDialog = new ProgressDialog(GeoSpecialPromotion.this);
                    ...
                    public void onResponse(JSONObject objone)
                    {
                        ...
                        try {
                            ...
                            if(error){
                                ...
                                adapter = new SpAdap(GeoSpecialPromotion.this,promotionlist);
        ...
        RequestQueue queue = Volley.newRequestQueue(GeoSpecialPromotion.this);
