...
public class GeoEditProfile extends AppCompatActivity implements View.OnClickListener{
    Button msavebtn;
    ImageView mfimage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_edit_profile);
        ...
        mfimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder mbuilder = new AlertDialog.Builder(GeoEditProfile.this);
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(GeoEditProfile.this, ProfileActivity.class));
        finish();
    ...
    class EditPro extends AsyncTask<String, Void, String> {
        ...
        String userid = SaveUserId.getInstance(GeoEditProfile.this).getUserId();
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(GeoEditProfile.this);
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                if(check) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(GeoEditProfile.this);
