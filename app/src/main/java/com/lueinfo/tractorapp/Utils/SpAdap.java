...
import com.lueinfo.tractorapp.SpecialPromotionDetail;
...
public class SpAdap extends BaseAdapter {
    ...
    public SpAdap(Context context, List<PromotionModel> movie) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.mgridimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(activity, SpecialPromotionDetail.class);
