...
public class HomeFragment extends Fragment implements View.OnClickListener {
    Button introducer, news, promotion, paidItem, transaction, spinBtn, tableReservation, profile,mqrcodebtn,mmenubtn,
            song_request, gallery,live_stream,cofday,rate_singer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cofday = (Button)view.findViewById(R.id.cofday);

        rate_singer = (Button)view.findViewById(R.id.rate_singer);
        ...
        rate_singer.setOnClickListener(this);

        live_stream.setOnClickListener(this);
        cofday.setOnClickListener(this);
        rate_singer.setOnClickListener(this);
        rate_singer.setOnClickListener(this);
        ...
        switch (view.getId()){
            ...
            case R.id.news:
             startActivity(new Intent(getActivity().getApplicationContext(), NewsBuletin.class));
                break;
            case R.id.promotion:
                startActivity(new Intent(getActivity().getApplicationContext(), SpecialPromotion.class));
                break;
            case R.id.paidItem:
